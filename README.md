...
Bluepill officially supports **Xcode 13.2**. If you're looking for old Xcode support, please checkout the following branches:
...
* [Xcode-13.1](https://github.com/mobilenativefoundation/bluepill/tree/xcode-13.1)
