...
@class DTXChannel, DVTDeviceType, DVTExtension, DVTPlatform, NSArray, NSData, NSError, NSMutableSet, NSOrderedSet, NSSet, NSString, NSURL;
...
- (void)setActiveProxiedDevice:(id <DVTBasicDevice>)arg1;
