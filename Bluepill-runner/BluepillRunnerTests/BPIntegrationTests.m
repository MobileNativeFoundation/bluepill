...
- (void)testTwoBPInstancesWithXCTestRunFile {
    ...
    self.config.xcTestRunPath = [[[[BPTestHelper derivedDataPath] stringByDeletingLastPathComponent] stringByDeletingLastPathComponent] stringByAppendingPathComponent:xcTestRunFile];
    NSError *err;
